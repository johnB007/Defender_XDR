...
$Groups = @(
    ...
    (New-Group -Name 'group-agents-mcp' -TabValue 'AgentsMCP' -Items @(
        ...
        (New-QueryItem -Name 'agent-mcp-trend' -Title 'Daily Agent Executions and MCP Invocations' -Query $AgentMcpTrend -Visualization 'areachart' -Width '60' -Height '50' -ChartSettings ([ordered]@{ seriesLabelSettings = @([ordered]@{ seriesName = 'Agent executions'; color = 'blue' }, [ordered]@{ seriesName = 'MCP invocations'; color = 'orange' }) })),
